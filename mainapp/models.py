...
class MainProduct(models.Model):
    ...
    reduction = models.CharField('Аббревиатура', max_length=30, blank=False)
    category = models.CharField('Категория', max_length=50)
    similar = models.ManyToManyField('self', blank=True, symmetrical=False, related_name='related_products')
